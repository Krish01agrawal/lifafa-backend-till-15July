...
async def fetch_emails(service, user_id='me', max_results=2500):
    """
    Fetch emails with proper pagination to get last 5 months of data
    Gmail API limits each request to 500 messages, so we need pagination
    """
    
    # Limited time range for last 5 months of data
    query_filter = 'newer_than:150d'  # 150 days = 5 months
    ...
    print(f"📊 Data range: {query_filter} ({150} days)")
